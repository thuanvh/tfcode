...
class PoseEstimator:
    ...
    def __init__(self, img_size=(480, 640), model_file="assets/model.txt"): #Thuan
        self.size = img_size
        ...
        self.model_points_68 = self._get_full_model_points(model_file) #Thuan
    ...
    def pose_angle(self, rotation_vector, translation_vector): #Thuan
        rotCamerMatrix1 = cv2.Rodrigues(rotation_vector)
