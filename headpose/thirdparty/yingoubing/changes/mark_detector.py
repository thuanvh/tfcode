...
class FaceDetector:
    ...
    def get_faceboxes(self, image, threshold=0.5):
        ...
        self.face_net.setInput(cv2.dnn.blobFromImage(
            image, 1.0, (300, 300), (104.0, 177.0, 123.0), False)) #Thuan
...
class MarkDetector:
    ...
    def __init__(self, mark_model='assets/frozen_inference_graph.pb', dnn_proto_text='assets/deploy.prototxt',
                 dnn_model='assets/res10_300x300_ssd_iter_140000.caffemodel'):
        """Initialization"""
        # A face detector is required for mark detection.
        self.face_detector = FaceDetector(dnn_proto_text, dnn_model)
