...
output_folder = "D:/sandbox/vmakeup/repos/src/learncnn/model_face/model29_headpose/_data/facepoint_" + str(inputsize) + "_" + str(base_name) + "/"
h5_name = ["combine"]
...
def sample_gen(rangename,start_idx, end_idx):
    ...
    for cur_idx in range(start_idx, end_idx):
        ...
        label_list = np.reshape(pt2d, (pt2d.shape[0] * pt2d.shape[1]))
