...
def cnn_model_fn(features, labels, mode):
  ...
  input_layer = tf.placeholder(features["x"], [-1, 100, 100, 3], name="input")
  ...
  if mode == tf.estimator.ModeKeys.TRAIN:
    ...
    train_op = optimizer.minimize(loss=loss,global_step=tf.train.get_global_step().astype(tf.int32))
