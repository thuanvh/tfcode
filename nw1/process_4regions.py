    ...
    for imgfile in imglist:        
        ...
        if(os.path.exists(lblfile)):
            for i in range(0, sample_number):
                ...
                tf.dleft = 0 if i % (sample_number/10) == 0 else random()
                tf.dright = 0 if i % (sample_number/10) == 0 else random()
                tf.dtop = 0 if i % (sample_number/10) == 0 else random()
                tf.dbottom = 0 if i % (sample_number/10) == 0 else random()
